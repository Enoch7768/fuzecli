...
func (p *Provider) responseFormat(opts provider.RequestOptions) any {
	...
	if opts.JSONSchema != nil {
		return map[string]any{"type": "json_schema", "json_schema": map[string]any{"name": "fuzecli_response", "strict": opts.JSONSchemaStrict, "schema": sanitizeSchema(opts.JSONSchema)}}
	}
