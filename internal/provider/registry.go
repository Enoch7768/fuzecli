...
func newCatalogProvider(name string) Provider {
	...
	case "github-models": return githubmodels.New(cfg.APIKey, cfg.BaseURL)
	...
	case "inference-net": return inferencenet.New(cfg.APIKey, cfg.BaseURL)
	case "portkey": return portkey.New(cfg.APIKey, cfg.BaseURL)
	case "databricks": return databricks.New(cfg.APIKey, cfg.BaseURL)
	case "azure-openai": return azureopenai.New(cfg.APIKey, cfg.BaseURL)
